...
# Test get_force by calling it with the arguments train_mass = 22680 and train_acceleration = 10.
...
# Test get_work by using it on train_mass = 22680, train_acceleration = 10, and train_distance = 100. Save the result to a variable called train_work.
